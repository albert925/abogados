...
<head>
	...
	<title>Administrar imagenes|Vargas Nossa y Asociados</title>
...
<body>
	...
	<article id="automargen" class="menuP">
		<nav id="mnP">
			<a class="sel" href="../galeria">Imagenes I.</a>
	...
	<section class="marsec">
		<h1>Slider inicio Imagenes</h1>
		<article id="automargen">
			<article id="cjA" class="cjaing">
				<form action="#" method="post" enctype="multipart/form-data" id="nvG" class="columninput">
					<label for="txgal"><b>Texto (max 36 caracteres)</b></label>
					<input type="text" id="txgal" name="txgla" />
					<label for="galimg"><b>Nuevo Imagen (resolución 1170x570)</b></label>
					<input type="file" id="galimg" name="galimg" required />
					<div id="txA"></div>
					<input type="submit" value="Subir e ingresar" id="clnvgal" />
				</form>
			</article>
		</article>
		<article id="automargen" class="flxB">
			...
			?>
			<figure>
				<img src="../../../<?php echo $rtgal ?>" alt="imange_<?php echo $idr ?>_<?php echo $idgal ?>" />
				<figcaption class="columninput">
					<a class="dell" href="borrimagen.php?br=<?php echo $idgal ?>">Borrar</a>
				</figcaption>
			</figure>
			<?php
				}
