...
<head>
	...
	<title>Administrar Portafolio|Vargas Nossa y Asociados</title>
...
<body>
	...
	<article id="automargen" class="menuP">
		<nav id="mnP">
			...
			<a class="sel" href="../portafolio">Portafolio</a>
	...
	<section class="marsec">
		...
		<article id="automargen">
			<article>
				<form action="modif_portal.php" method="post" class="columninput">
					<textarea id="editor1" name="txtpf" rows="150"><?php echo "$textopf"; ?></textarea>
					<script>
						CKEDITOR.replace('txtpf');
					</script>
					<div id="txA"></div>
