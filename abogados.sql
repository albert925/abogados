...
--
-- Estructura de tabla para la tabla `abogad`
--

CREATE TABLE IF NOT EXISTS `abogad` (
`id_ab` int(11) NOT NULL,
  `nam_ab` varchar(255) COLLATE utf8_spanish_ci NOT NULL,
...
`id_nt` int(11) NOT NULL,
  `tit_nt` varchar(255) COLLATE utf8_spanish_ci NOT NULL,
  `tp_id` int(11) NOT NULL,
  `rut_nt` varchar(455) COLLATE utf8_spanish_ci NOT NULL,
...
--
ALTER TABLE `noticias`
ADD CONSTRAINT `noticias_ibfk_1` FOREIGN KEY (`tp_id`) REFERENCES `tipo_noticia` (`id_tp`) ON DELETE CASCADE ON UPDATE CASCADE;
